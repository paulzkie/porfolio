...
header('location:index.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update users set firstname='$firstname',lastname='$lastname',contactno='$contactno' where id='".$_SESSION['id']."'");
		if($query)
		{
...
<div class="form-group">
					    ...
					    <input type="text" class="form-control unicase-form-control text-input" value="<?php echo $row['firstname'];?>" id="firstname" name="firstname" required="required">
					  </div>
<div class="form-group">
					    <label class="info-title" for="lasstname">Name<span>*</span></label>
					    <input type="text" class="form-control unicase-form-control text-input" value="<?php echo $row['lastname'];?>" id="lastname" name="lastname" required="required">
					  </div>
