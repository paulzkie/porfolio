...
<div class="controls">
<input type="file" name="productimage1" id="productimage1" value="" class="span8 tip" accept="image/*" onchange="preview_image(event)" required>
 <img id="output_image" style="width: 35%;"/>
</div>
</div>
...
<div class="controls">
<input type="file" name="productimage2"  class="span8 tip" accept="image/*" onchange="preview_image1(event)" required>
 <img id="output_image1" style="width: 35%;"/>
</div>
</div>
...
<div class="controls">
<input type="file" name="productimage3"  class="span8 tip" accept="image/*" onchange="preview_image2(event)">
 <img id="output_image2" style="width: 35%;"/>
</div>
</div>
