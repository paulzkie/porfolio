...
if(isset($_GET["stat"])){
	...
	mysqli_query($con, "update orders set stat='".$_GET["stat"]."', orderStatus='".$_GET["orderstat"]."' where id = '".$_GET["orderid"]."' ");
}
?>
<!DOCTYPE html>
<html lang="en">
...
?>										
						...
						<td><?php echo htmlentities($row['shippingaddress'].",".$row['shippingcity']);?></td>
											...
											<td><a href="delivered-orders.php?orderid=<?php echo $row['id']?>&orderstat=Return Item&stat=1" class="btn-return">Return Item</a>
												<a href="delivered-orders.php?orderid=<?php echo $row['id']?>&orderstat=Damage Item&stat=2" class="btn-damage">Damage Item</a>
                                                <a href="delivered-orders.php?orderid=<?php echo $row['id']?>&orderstat=Change Item&stat=3" class="btn-change">Changed Item</a>
											</td>
											</tr>
